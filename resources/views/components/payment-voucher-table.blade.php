            ...
            <td style="padding: 0; border: 1px solid #e2e8f0;" colspan="4">
                <div
                    ...
                    <div style="text-align: center;">
                        <div
                            style="background: linear-gradient(135deg, #2563eb 0%, #1d4ed8 100%); color: #ffffff; padding: 12px 20px; font-weight: 700; text-align: center; border-radius: 8px; margin-bottom: 10px; font-size: 15px; text-transform: uppercase; letter-spacing: 0.5px; box-shadow: 0 4px 6px -1px rgba(37, 99, 235, 0.3);">
