                        ...
                        <tbody>
                            ...
                            <tr style="background-color: #ffffff; border-radius: 4px;">
                                ...
                                <td
                                    ...
                                    {{ Illuminate\Support\Number::dominicanCurrency($detail->rawSalary, in: 'USD') }}
                                </td>
                            </tr>
                            <!-- Income Adjustments -->
                            @if ($detail->incomes->count() > 0)
            ...
            <td style="padding: 0; border: 1px solid #e2e8f0;" colspan="2">
                <div
                    ...
                    <div
                        ...
                        {{ Illuminate\Support\Number::dominicanCurrency($detail->incomeTotal, in: 'USD') }}
                    </div>
                </div>
            </td>
            <td style="padding: 0; border: 1px solid #e2e8f0;" colspan="2">
                <div
                    ...
                    <div
                        ...
                        {{ Illuminate\Support\Number::dominicanCurrency($detail->deductionTotal, in: 'USD') }}
                    </div>
                </div>
            </td>
        </tr>
            ...
            <td style="padding: 0; border: 1px solid #e2e8f0;" colspan="4">
                <div
                    ...
                    <div style="text-align: center;">
                        <div
                            style="background-color: #1d4ed8; color: #ffffff; padding: 12px 20px; font-weight: 700; text-align: center; border-radius: 8px; margin-bottom: 10px; font-size: 15px; text-transform: uppercase; letter-spacing: 0.5px; box-shadow: 0 4px 6px -1px rgba(37, 99, 235, 0.3);">
                        ...
                        <div
                            ...
                            {{ Illuminate\Support\Number::dominicanCurrency($detail->netSalary, in: 'USD') }}
                        </div>
